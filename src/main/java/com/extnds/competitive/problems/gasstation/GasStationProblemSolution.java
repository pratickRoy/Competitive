 ...
 *
 */
public interface GasStationProblemSolution {

    int ROUTE_CANT_BE_COMPLETED_FLAG = -1;

    int getMinStationIndexForCircuitCompletionOrNegativeOneIfNotPossible(
